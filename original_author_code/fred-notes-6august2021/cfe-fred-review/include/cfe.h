...
// Conceptual Functional Equivalent (CFE) of the National Water Model v 1.2, 2.0, and 2.1
...
struct cfe_model {
    ...
    int num_timesteps;
    int current_time_step_count;  // changed FLO
    int time_step_seconds;        // changed FLO
