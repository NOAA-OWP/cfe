...
giuh_ordinates[0]=0.1;  // note these sum to 1.0.  If we have N ordinates, we need a queue sized N+1 to perform
giuh_ordinates[1]=0.35;  // the convolution.
giuh_ordinates[2]=0.2;
giuh_ordinates[3]=0.14;
giuh_ordinates[4]=0.1;
giuh_ordinates[5]=0.06;
giuh_ordinates[6]=0.05;
/*
...
gw_reservoir.storage_m=gw_reservoir.storage_max_m*0.01;  // INITIALIZE HALF FULL.
//-------------------------------------------------------------------------------------------------------------
